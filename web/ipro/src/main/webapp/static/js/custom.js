...
jQuery(document).ready(function() {
   ...
   function closeVisibleSubSubMenu(parent) {
   ...
   var cssSkin = '../static/css/style.'+c+'.css';
   if (jQuery('body').css('direction') == 'rtl') {
      cssSkin = '../static/css/style.'+c+'.css';
   ...
   if(fnt) {
      jQuery('head').append('<link id="fontswitch" rel="stylesheet" href="../static/css/font.'+fnt+'.css" />');
   }
