...
<div class="leftpanel">
	...
	<div class="leftpanelinner">
		...
		<div class="visible-xs hidden-sm hidden-md hidden-lg">
			...
			<h5 class="sidebartitle actitle">用户帐户</h5>
			<ul class="nav nav-pills nav-stacked nav-bracket mb30">
				...
				<li><a href="${ctx }/demo/signin.html"><i class="fa fa-sign-out"></i> <span>退出</span></a></li>
			</ul>
		</div>
		...
		<ul class="nav nav-pills nav-stacked nav-bracket">
			<li class="active"><a href="${ctx }/demo/index.html"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
			<li><a href="${ctx }/demo/email.html"><span class="pull-right badge badge-success">2</span><i class="fa fa-envelope-o"></i> <span>Email</span></a></li>
