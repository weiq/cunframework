...
<div class="headerbar">
	...
	<form class="searchform" action="${ctx}/demo/index.html" method="post">
				...
				<div class="btn-group">
					...
					<div class="dropdown-menu dropdown-menu-head pull-right">
						...
						<ul class="dropdown-list user-list">
							<li class="new">
								<div class="thumb">
									<a href=""><img src="${ctx}/static/images/photos/user1.png" alt="" /></a>
								</div>
								<div class="desc">
									<h5>
							...
							<li class="new">
								<div class="thumb">
									<a href=""><img src="${ctx}/static/images/photos/user2.png" alt="" /></a>
								</div>
								<div class="desc">
									<h5>
							...
							<li>
								<div class="thumb">
									<a href=""><img src="${ctx}/static/images/photos/user3.png" alt="" /></a>
								</div>
								<div class="desc">
									<h5>
							...
							<li>
								<div class="thumb">
									<a href=""><img src="${ctx}/static/images/photos/user4.png" alt="" /></a>
								</div>
								<div class="desc">
									<h5>
							...
							<li>
								<div class="thumb">
									<a href=""><img src="${ctx}/static/images/photos/user5.png" alt="" /></a>
								</div>
								<div class="desc">
									<h5>
					...
					<div class="dropdown-menu dropdown-menu-head pull-right">
						...
						<ul class="dropdown-list gen-list">
							<li class="new"><a href=""> <span class="thumb"><img
										src="${ctx}/static/images/photos/user1.png" alt="" /></span> <span
							...
							<li><a href=""> <span class="thumb"><img
										src="${ctx}/static/images/photos/user2.png" alt="" /></span> <span
									class="desc"> <span class="name">Nusja Nawancali</span>
										<span class="msg">Lorem ipsum dolor sit amet...</span>
								</span>
							</a></li>
							<li><a href=""> <span class="thumb"><img
										src="${ctx}/static/images/photos/user3.png" alt="" /></span> <span
									class="desc"> <span class="name">Weno Carasbong</span> <span
										class="msg">Lorem ipsum dolor sit amet...</span>
								</span>
							</a></li>
							<li><a href=""> <span class="thumb"><img
										src="${ctx}/static/images/photos/user4.png" alt="" /></span> <span
									class="desc"> <span class="name">Zaham Sindilmaca</span>
										<span class="msg">Lorem ipsum dolor sit amet...</span>
								</span>
							</a></li>
							<li><a href=""> <span class="thumb"><img
										src="${ctx}/static/images/photos/user5.png" alt="" /></span> <span
									class="desc"> <span class="name">Veno Leongal</span> <span
										class="msg">Lorem ipsum dolor sit amet...</span>
								</span>
							</a></li>
				...
				<div class="btn-group">
					...
					<div class="dropdown-menu dropdown-menu-head pull-right">
						...
						<ul class="dropdown-list gen-list">
							<li class="new"><a href=""> <span class="thumb"><img
										src="${ctx}/static/images/photos/user4.png" alt="" /></span> <span
									class="desc"> <span class="name">Zaham Sindilmaca
