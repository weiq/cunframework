				...
				<div class="panel panel-success panel-stat">
					<div class="panel-heading">
						...
						<div class="stat">
							<div class="row">
								<div class="col-xs-4">
									<img src="${ctx}/static/images/is-user.png" alt="" />
								</div>
								<div class="col-xs-8">
				...
				<div class="panel panel-danger panel-stat">
					<div class="panel-heading">
						...
						<div class="stat">
							<div class="row">
								<div class="col-xs-4">
									<img src="${ctx}/static/images/is-document.png" alt="" />
								</div>
								<div class="col-xs-8">
				...
				<div class="panel panel-dark panel-stat">
					<div class="panel-heading">
						...
						<div class="stat">
							<div class="row">
								<div class="col-xs-4">
									<img src="${ctx}/static/images/is-money.png" alt="" />
								</div>
								<div class="col-xs-8">
		...
		<div class="row">
			<div class="col-sm-6 col-md-4">
				<div class="panel panel-default widget-photoday">
					<div class="panel-body">
						<a href="" class="photoday"><img
							src="${ctx}/static/images/photos/photo1.png" alt="" /></a>
						<div class="photo-details">
							<h4 class="photo-title">Strawhat In The Beach</h4>
							<small class="text-muted"><i class="fa fa-map-marker"></i>
								San Franciso, California, USA</small> <small>By: <a href="">ThemePixels</a></small>
						</div>
						<!-- photo-details -->
						<ul class="photo-meta">
					...
					<div class="panel-body">
						<ul>
							<li><small class="pull-right">Dec 10</small>
								<h4 class="sender">Jennier Lawrence</h4> <small>Lorem
									ipsum dolor sit amet...</small></li>
							<li><small class="pull-right">Dec 9</small>
								<h4 class="sender">Marsha Mellow</h4> <small>Lorem ipsum
									dolor sit amet...</small></li>
							<li><small class="pull-right">Dec 9</small>
								<h4 class="sender">Holly Golightly</h4> <small>Lorem
									ipsum dolor sit amet...</small></li>
							<li><small class="pull-right">Dec 10</small>
								<h4 class="sender">Jennier Lawrence</h4> <small>Lorem
									ipsum dolor sit amet...</small></li>
					...
					<div class="panel-body">
						<ul class="nav nav-tabs nav-justified">
							<li class="active"><a href="#post-status" data-toggle="tab"><i
									class="fa fa-pencil"></i> <strong>Status</strong></a></li>
							<li><a href="#post-photo" data-toggle="tab"><i
									class="fa fa-picture-o"></i> <strong>Photo</strong></a></li>
							<li><a href="#post-checkin" data-toggle="tab"><i
									class="fa fa-map-marker"></i> <strong>Check-In</strong></a></li>
						</ul>
