...
<body>
    ...
    <div class="contentpanel">
      ...
      <div class="row">
        <div class="col-sm-3">
          <img src="${ctx}/static/images/photos/profile-1.png" class="thumbnail img-responsive" alt="" />
        ...
        <div class="tab-content">
            ...
            <div class="activity-list">
              ...
              <div class="media act-media">
                <a class="pull-left" href="#">
                  <img class="media-object act-thumb" src="${ctx}/static/images/photos/user1.png" alt="" />
                </a>
              ...
              <div class="media act-media">
                <a class="pull-left" href="#">
                  <img class="media-object act-thumb" src="${ctx}/static/images/photos/userprofile.png" alt="" />
                </a>
                <div class="media-body act-media-body">
                  ...
                  <div class="media blog-media">
                    <a class="pull-left" href="#">
                      <img class="media-object" src="${ctx}/static/images/photos/media5.png" alt="" />
                    </a>
              ...
              <div class="media act-media">
                <a class="pull-left" href="#">
                  <img class="media-object act-thumb" src="${ctx}/static/images/photos/user2.png" alt="" />
                </a>
                <div class="media-body act-media-body">
              ...
              <div class="media act-media">
                ...
                <div class="media-body act-media-body">
                  ...
                  <ul class="uploadphoto-list">
                    <li><a href="${ctx}/static/images/photos/media1.jpg" data-rel="prettyPhoto"><img src="${ctx}/static/images/photos/media1.jpg" class="img-responsive" alt="" /></a></li>
                    <li><a href="${ctx}/static/images/photos/media2.png" data-rel="prettyPhoto"><img src="${ctx}/static/images/photos/media2.png" class="img-responsive" alt="" /></a></li>
                    <li><a href="${ctx}/static/images/photos/media3.png" data-rel="prettyPhoto"><img src="${ctx}/static/images/photos/media3.png" class="img-responsive" alt="" /></a></li>
                  </ul>
                </div>
              </div><!-- media -->
              ...
              <div class="media act-media">
                <a class="pull-left" href="#">
                  <img class="media-object act-thumb" src="${ctx}/static/images/photos/user4.png" alt="" />
                </a>
                <div class="media-body act-media-body">
              ...
              <div class="media act-media">
                ...
                <div class="media-body act-media-body">
                  ...
                  <div class="media blog-media">
                    <a class="pull-left" href="#">
                      <img class="media-object" src="${ctx}/static/images/photos/media4.png" alt="" />
                    </a>
                    <div class="media-body">
                      <h4 class="media-title"><a href="">Ut Enim Ad Minim Veniam</a></h4>
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat... <a href="">Read more</a></p>
              ...
              <div class="media act-media">
                ...
                <div class="media-body act-media-body">
                  ...
                  <div class="mb20"></div>
                  <a href="${ctx}/static/images/photos/media6.png" data-rel="prettyPhoto" class="img-single"><img src="${ctx}/static/images/photos/media6.png" class="img-responsive" alt="" /></a>
                </div>
              </div><!-- media -->
              
              <div class="media act-media">
                <a class="pull-left" href="#">
                  <img class="media-object act-thumb" src="${ctx}/static/images/photos/user5.png" alt="" />
                </a>
                <div class="media-body act-media-body">
              ...
              <div class="media act-media">
                ...
                <div class="media-body act-media-body">
                  ...
                  <div class="media blog-media">
                    <a class="pull-left" href="#">
                      <img class="media-object" src="${ctx}/static/images/photos/media7.png" alt="" />
                    </a>
                    <div class="media-body">
                      <h4 class="media-title"><a href="">Ut Enim Ad Minim Veniam</a></h4>
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat... <a href="">Read more</a></p>
          ...
          <div class="tab-pane" id="followers">
            ...
            <div class="follower-list">
              ...
              <div class="media">
                <a class="pull-left" href="#">
                  <img class="media-object" src="${ctx}/static/holder.js/100x125" alt="" />
                </a>
                <div class="media-body">
            ...
            <div class="activity-list">
              ...
              <div class="media act-media">
                ...
                <div class="media-body act-media-body">
                  ...
                  <ul class="uploadphoto-list">
                    <li><a href="${ctx}/static/images/photos/media5.png" data-rel="prettyPhoto"><img src="${ctx}/static/images/photos/media5.png" class="img-responsive" alt="" /></a></li>
                    <li><a href="${ctx}/static/images/photos/media4.png" data-rel="prettyPhoto"><img src="${ctx}/static/images/photos/media4.png" class="img-responsive" alt="" /></a></li>
                  </ul>
                </div>
              </div><!-- media -->
              ...
              <div class="media act-media">
                ...
                <div class="media-body act-media-body">
                  ...
                  <ul class="uploadphoto-list">
                    <li><a href="${ctx}/static/images/photos/media6.png" data-rel="prettyPhoto"><img src="${ctx}/static/images/photos/media6.png" class="img-responsive" alt="" /></a></li>
                    <li><a href="${ctx}/static/images/photos/media7.png" data-rel="prettyPhoto"><img src="${ctx}/static/images/photos/media7.png" class="img-responsive" alt="" /></a></li>
                    <li><a href="${ctx}/static/images/photos/media2.png" data-rel="prettyPhoto"><img src="${ctx}/static/images/photos/media2.png" class="img-responsive" alt="" /></a></li>
                  </ul>
                </div>
              </div><!-- media -->
              ...
              <div class="media act-media">
                <a class="pull-left" href="#">
                  <img class="media-object act-thumb" src="${ctx}/static/images/photos/user3.png" alt="" />
                </a>
                <div class="media-body act-media-body">
                  ...
                  <div class="media blog-media">
                    <a class="pull-left" href="#">
                      <img class="media-object" src="${ctx}/static/images/photos/media3.png" alt="" />
                    </a>
                    <div class="media-body">
                      <h4 class="media-title"><a href="">Ut Enim Ad Minim Veniam</a></h4>
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat... <a href="">Read more</a></p>
            ...
            <div class="events">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="media">
                    <a class="pull-left" href="#">
                      <img class="media-object" src="${ctx}/static/holder.js/100x120" alt="" />
                    </a>
