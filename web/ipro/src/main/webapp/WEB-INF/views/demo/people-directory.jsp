        ...
        <div class="row">
            ...
            <div class="people-item">
              <div class="media">
                <a href="#" class="pull-left">
                  <img alt="" src="${ctx}/static/images/photos/user2.png" class="thumbnail media-object">
                </a>
          ...
          <div class="col-md-6">
            <div class="people-item">
              <div class="media">
                <a href="#" class="pull-left">
                  <img alt="" src="${ctx}/static/holder.js/110x110" class="thumbnail media-object">
                </a>
                <div class="media-body">
          ...
          <div class="col-md-6">
            <div class="people-item">
              <div class="media">
                <a href="#" class="pull-left">
                  <img alt="" src="${ctx}/static/images/photos/user3.png" class="thumbnail media-object">
                </a>
                <div class="media-body">
          ...
          <div class="col-md-6">
            <div class="people-item">
              <div class="media">
                <a href="#" class="pull-left">
                  <img alt="" src="${ctx}/static/images/photos/user4.png" class="thumbnail media-object">
                </a>
                <div class="media-body">
          ...
          <div class="col-md-6">
            <div class="people-item">
              <div class="media">
                <a href="#" class="pull-left">
                  <img alt="" src="${ctx}/static/images/photos/user5.png" class="thumbnail media-object">
                </a>
                <div class="media-body">
