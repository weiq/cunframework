...
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`, `icon`)
  values (2, 1, '0/1/', 1, '示例管理', 'showcase', '', true, 'fa fa-magnet');;
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
...
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`, `icon`)
  values (16, 1, '0/1/', 2, '系统管理', 'sys', '', true, 'fa fa-suitcase');;

insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
  values (17, 16, '0/1/16/', 1, '用户管理', 'user', '', true);;
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
  values (18, 17, '0/1/16/17/', 1, '用户列表', 'userList', '/admin/sys/user/userList', true);;
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
...
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`, `icon`)
  values (31, 1, '0/1/', 4, '个人中心', '', '', true, 'fa fa-user');;
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
...
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`, `icon`)
  values (33, 1, '0/1/', 5, '开发维护', 'maintain', '', true, 'fa fa-wrench');;
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
...
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`, `icon`)
  values (39, 1, '0/1/', 6, '系统监控', 'monitor', '', true, 'fa fa-desktop');;
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
