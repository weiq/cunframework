...
import org.cunframework.web.ipro.personal.message.entity.MessageContent;
import org.cunframework.web.ipro.personal.message.entity.MessageState;
import org.cunframework.web.ipro.personal.message.entity.MessageType;
    ...
    public void sendSystemMessageToAllUser(Message message) {
        ...
        do {
            ...
            try {
                ...
                LogUtils.logError("send system message to all user error", username, e);
            }
