package org.cunframework.web.ipro.admin.resource.service;
...
public class ResourceService extends BaseTreeableService<Resource, Long> {
    ...
    private static Menu convertToMenu(Resource resource) {
        return new Menu(resource.getId(), resource.getIdentity(), resource.getName(), resource.getIcon(), resource.getUrl());
    }
