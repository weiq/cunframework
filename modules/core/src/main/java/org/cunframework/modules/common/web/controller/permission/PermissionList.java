package org.cunframework.modules.common.web.controller.permission;
...
public class PermissionList implements Serializable {
    ...
    public void assertHasPermission(String permission, String errorCode) {
        ...
        if (!SecurityUtils.getSubject().isPermitted(resourcePermission)) {
            throw new UnauthorizedException(MessageUtil.message(errorCode, resourcePermission));
        }
    }
    ...
    public void assertHasAllPermission(String[] permissions, String errorCode) {
        ...
        if (permissions == null || permissions.length == 0) {
            throw new UnauthorizedException(MessageUtil.message(errorCode, resourceIdentity + ":" + Arrays.toString(permissions)));
        }
