...
import org.cunframework.modules.common.plugin.web.controller.entity.ZTree;
...
public abstract class BaseTreeableController<M extends BaseEntity<ID> & Treeable<ID>, ID extends Serializable>
    ...
    public Object load(
            ...
            @RequestParam(value = "asyncLoadAll", required = false, defaultValue = "false") boolean asyncLoadAll,
            @RequestParam(value = "searchName", required = false) String searchName,
