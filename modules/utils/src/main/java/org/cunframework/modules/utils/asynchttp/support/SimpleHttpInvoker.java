package org.cunframework.modules.utils.asynchttp.support;

import org.cunframework.modules.utils.asynchttp.AsyncHttpConnection;
import org.cunframework.modules.utils.asynchttp.support.ParamsWrapper.NameValue;
import org.cunframework.modules.utils.asynchttp.support.ParamsWrapper.PathParam;
import org.cunframework.modules.utils.asynchttp.utility.MIMEType;
import org.cunframework.modules.utils.asynchttp.utility.TextUtils;
...
public class SimpleHttpInvoker extends RequestInvoker {
	...
	protected void execute() {
        ...
        try{
            ...
            exp.printStackTrace();
            callback.onConnectError(exp,args);
        }catch (Throwable exp){
            exp.printStackTrace();
            callback.onUncatchedError(exp,args);
        }
